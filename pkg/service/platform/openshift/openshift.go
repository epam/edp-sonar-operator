...
func (service OpenshiftService) CreateDeployment(sonar v1alpha1.Sonar) error {
	...
	sonarDcObject := newSonarDeploymentConfig(sonar.Name, sonar.Namespace, sonar.Spec.Image, labels, sonar.Spec.Version)
...
func newSonarDeploymentConfig(name string, namespace string, image string, labels map[string]string, version string) *appsV1Api.DeploymentConfig {
