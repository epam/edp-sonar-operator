...
const (
	...
	namespace = "test-sonar-permission-template"
...
func TestPermissionTemplate(t *testing.T) {
	...
	RunSpecs(t, "PermissionTemplate Controller Suite")
}
...
var _ = BeforeSuite(func() {
	...
	err = NewSonarPermissionTemplateReconciler(
		k8sManager.GetClient(),
		k8sManager.GetScheme(),
		sonarclient.NewApiClientProvider(k8sManager.GetClient()),
	).
