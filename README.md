...
```bash
helm install sonar-operator --namespace <edp_cicd_project> --set name=sonar-operator --set namespace=<edp_cicd_project> --set platform=<platform_type> --set image.name=epamedp/sonar-operator --set image.version=<operator_version> deploy-templates
```
