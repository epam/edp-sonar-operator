...
//+kubebuilder:rbac:groups=edp.epam.com,resources=sonarqualitygates,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=edp.epam.com,resources=sonarqualitygates/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=edp.epam.com,resources=sonarqualitygates/finalizers,verbs=update
