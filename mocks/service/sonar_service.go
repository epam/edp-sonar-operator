...
func (_m *ServiceInterface) Configure(ctx context.Context, instance *sonarApi.Sonar) error {
	ret := _m.Called(ctx, instance)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *sonarApi.Sonar) error); ok {
		r0 = rf(ctx, instance)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *ServiceInterface) ExposeConfiguration(ctx context.Context, instance *sonarApi.Sonar) error {
	ret := _m.Called(ctx, instance)
...
func (_m *ServiceInterface) Integration(ctx context.Context, instance *sonarApi.Sonar) (*sonarApi.Sonar, error) {
	ret := _m.Called(ctx, instance)

	var r0 *sonarApi.Sonar
	if rf, ok := ret.Get(0).(func(context.Context, *sonarApi.Sonar) *sonarApi.Sonar); ok {
		r0 = rf(ctx, instance)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*sonarApi.Sonar)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *sonarApi.Sonar) error); ok {
		r1 = rf(ctx, instance)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ServiceInterface) IsDeploymentReady(instance *sonarApi.Sonar) (bool, error) {
	ret := _m.Called(instance)

	var r0 bool
	if rf, ok := ret.Get(0).(func(*sonarApi.Sonar) bool); ok {
		r0 = rf(instance)
	} else {
		r0 = ret.Get(0).(bool)
	}
