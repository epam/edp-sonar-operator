...
type mockConstructorTestingTNewK8SClusterClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewK8SClusterClient creates a new instance of K8SClusterClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewK8SClusterClient(t mockConstructorTestingTNewK8SClusterClient) *K8SClusterClient {
	mock := &K8SClusterClient{}
	mock.Mock.Test(t)
