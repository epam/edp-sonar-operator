...
// ExtensionClient is an autogenerated mock type for the ExtensionClient type
type ExtensionClient struct {
	mock.Mock
}

// DaemonSets provides a mock function with given fields: namespace
func (_m *ExtensionClient) DaemonSets(namespace string) v1beta1.DaemonSetInterface {
...
func (_m *ExtensionClient) Deployments(namespace string) v1beta1.DeploymentInterface {
	ret := _m.Called(namespace)
...
func (_m *ExtensionClient) Ingresses(namespace string) v1beta1.IngressInterface {
	ret := _m.Called(namespace)
...
func (_m *ExtensionClient) NetworkPolicies(namespace string) v1beta1.NetworkPolicyInterface {
	ret := _m.Called(namespace)
...
func (_m *ExtensionClient) PodSecurityPolicies() v1beta1.PodSecurityPolicyInterface {
	ret := _m.Called()
...
func (_m *ExtensionClient) RESTClient() rest.Interface {
	ret := _m.Called()
...
func (_m *ExtensionClient) ReplicaSets(namespace string) v1beta1.ReplicaSetInterface {
	ret := _m.Called(namespace)
