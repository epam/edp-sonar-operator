...
// PodsStateClient is an autogenerated mock type for the PodsStateClient type
type PodsStateClient struct {
	mock.Mock
}

// ControllerRevisions provides a mock function with given fields: namespace
func (_m *PodsStateClient) ControllerRevisions(namespace string) v1.ControllerRevisionInterface {
...
func (_m *PodsStateClient) DaemonSets(namespace string) v1.DaemonSetInterface {
	ret := _m.Called(namespace)
...
func (_m *PodsStateClient) Deployments(namespace string) v1.DeploymentInterface {
	ret := _m.Called(namespace)
...
func (_m *PodsStateClient) RESTClient() rest.Interface {
	ret := _m.Called()
...
func (_m *PodsStateClient) ReplicaSets(namespace string) v1.ReplicaSetInterface {
	ret := _m.Called(namespace)
...
func (_m *PodsStateClient) StatefulSets(namespace string) v1.StatefulSetInterface {
	ret := _m.Called(namespace)
