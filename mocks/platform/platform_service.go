...
func (_m *Service) CreateConfigMap(instance *v1alpha1.Sonar, configMapName string, configMapData map[string]string) error {
	ret := _m.Called(instance, configMapName, configMapData)

	var r0 error
	if rf, ok := ret.Get(0).(func(*v1alpha1.Sonar, string, map[string]string) error); ok {
...
func (_m *Service) CreateEDPComponentIfNotExist(sonar *v1alpha1.Sonar, url string, icon string) error {
	ret := _m.Called(sonar, url, icon)

	var r0 error
	if rf, ok := ret.Get(0).(func(*v1alpha1.Sonar, string, string) error); ok {
...
func (_m *Service) GetAvailableDeploymentReplicas(instance *v1alpha1.Sonar) (*int, error) {
	ret := _m.Called(instance)

	var r0 *int
	if rf, ok := ret.Get(0).(func(*v1alpha1.Sonar) *int); ok {
		r0 = rf(instance)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*int)
...
func (_m *Service) SetOwnerReference(sonar *v1alpha1.Sonar, object client.Object) error {
	ret := _m.Called(sonar, object)

	var r0 error
	if rf, ok := ret.Get(0).(func(*v1alpha1.Sonar, client.Object) error); ok {
		r0 = rf(sonar, object)
	} else {
		r0 = ret.Error(0)
	}
