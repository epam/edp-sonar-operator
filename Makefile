...
# epamedp/sonar-operator-bundle:$VERSION and epamedp/sonar-operator-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= epamedp/sonar-operator
...
ifneq (${NEXT_RELEASE_TAG},)
	$(GITCHGLOG) --next-tag v${NEXT_RELEASE_TAG} -o CHANGELOG.md v2.14.1..
else
	$(GITCHGLOG) -o CHANGELOG.md v2.14.1..
endif
